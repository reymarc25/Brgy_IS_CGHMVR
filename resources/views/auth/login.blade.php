...
<body class="relative min-h-screen overflow-hidden antialiased" style="background:
    radial-gradient(980px circle at 14% 88%, rgba(56,189,248,0.34), transparent 52%),
    radial-gradient(900px circle at 92% 10%, rgba(37,99,235,0.44), transparent 50%),
    radial-gradient(760px circle at 52% -8%, rgba(16,185,129,0.2), transparent 46%),
    linear-gradient(135deg, #1f2a49 0%, #223d6f 46%, #1d4f89 100%);">
